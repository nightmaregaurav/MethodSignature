...
namespace MethodSignature
{
    public class MethodSignature
    {
        ...
        public new string ToString() => $"{string.Join(" ", AccessModifiers)} {(IsStatic ? "static " : "")}{ReturnType} {(Namespace != null ? Namespace + "." : "")}{ClassName}.{Name} ({string.Join(", ", Parameters.Select(x => x.ToString()))});";
    }
}
